...
class App(tk.Tk):
    def __init__(self):
        ...
        self.iconbitmap(os.path.join(self.images_folder, "password.ico"))
        ...
        self.image = ImageTk.PhotoImage(Image.open(os.path.join(self.images_folder, "password.png")).resize((20, 17)))
